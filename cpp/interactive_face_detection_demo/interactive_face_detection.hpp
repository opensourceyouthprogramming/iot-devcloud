...
static const char face_detection_output_location_message[] = "Required. Path to output results";
...
DEFINE_int32(n_ag, 16, num_batch_ag_message);
...
DEFINE_int32(n_hp, 16, num_batch_hp_message);
...
DEFINE_int32(n_em, 16, num_batch_em_message);
...
DEFINE_int32(n_lm, 16, num_batch_em_message);
...
/// The output results diectory
DEFINE_string(o, "", face_detection_output_location_message);
/**
...
static void showUsage() {
    ...
    std::cout << "    -o                         " << face_detection_output_location_message << std::endl;
}
